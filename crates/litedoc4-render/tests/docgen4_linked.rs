...
//!
//! `fixtures/render/docgen4-linked-expected.json` was generated by
...
//! `tools/oracle/dump-html-linked.lean`, the doc-gen4 half, is still here.
//!
...
const FIXTURE: &str = include_str!("../../../fixtures/render/docgen4-linked-expected.json");
...
fn expected() -> Expected {
    serde_json::from_str(FIXTURE).expect("fixtures/render/docgen4-linked-expected.json is valid")
}
